...
`dev-impl` is an implementation worker, not a discovery/research worker. When a runner-prepared implementation-context is present, treat it as the execution contract and move to edits quickly.
